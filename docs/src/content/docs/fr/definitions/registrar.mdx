...
description: Explorez les rôles d'un Bureau d'Enregistrement de noms de domaines, de leur enregistrement jusqu'à leur expiration.
---
...
## Voir aussi
  ...
  - [Ce qui se passe dans un Bureau d’Enregistrement (BE)](https://www.afnic.fr/observatoire-ressources/papier-expert/ce-qui-se-passe-dans-un-bureau-denregistrement-be/) de l'AFNIC
