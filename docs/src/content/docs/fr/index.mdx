...
head:
  - tag: title
    content: Domain Watchdog – Open Source Domain Monitoring via RDAP
---
...
<script type="application/ld+json" set:html={JSON.stringify(
    {
        ...
        "@graph": [
            ...
            {
                "@type": "WebApplication",
                "@id": "https://domainwatchdog.eu/#app",
                "name": "Domain Watchdog",
                "inLanguage": "fr",
            ...
            },
            {
                ...
                "@id": "https://domainwatchdog.eu/#source",
